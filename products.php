...
<div class="well well-small">
	...
	<ul class="nav nav-list">
	  ...
	  <input name="renkler-metin" list="renk-listesi" placeholder="Bir Renk seciniz" /></li>
     	<li><a href="products.html"><span style="color: red " class="icon-chevron-right"></span>Fashion</a></li>
